...
const TraineeLogin = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        axios.post(`${process.env.REACT_APP_BKD_URL}/trainee/login`, {
            uid: employeeId,
            password
        }).then((response) => {
            sessionStorage.setItem("token", response.data.data.token.val);
            sessionStorage.setItem("uid", response.data.data.trainee.uid);
    ...
    return (
        <div className="flex">
            ...
            <h1 className="text-2xl text-gray-700 font-bold mb-4">Trainee Login</h1>
